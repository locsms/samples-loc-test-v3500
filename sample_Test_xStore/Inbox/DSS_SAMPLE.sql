...
(30,Portal,sample_Test_xStore,ROOT,INSTALL.sql,2019040 03:52:56,@DJSF @FMT(T6F,@NOW),08BB7C9C),
(30,Portal,sample_Test_xStore,OFFICE,Samples.ini,2022036 11:29:24,@DJSF @FMT(T6F,@NOW),017FCCF2),
