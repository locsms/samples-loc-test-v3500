...
@wizRpl(Host_office.ini[DEPLOPY_CHG]vendor_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]mix_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]obj_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]kit_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]ecl_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]pos_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]price_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]cost_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]loc_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]alt_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]dsd_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_txt_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_nut_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_cpt_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_cct_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_csl_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_ctx_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]itz_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]itd_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]bmp_chg=1);
@wizRpl(Host_office.ini[DEPLOPY_CHG]clt_itm_chg=1);
...
@wizRpl(Host_office.ini[DEPLOPY_CHG]vendor_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]mix_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]obj_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]kit_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]ecl_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]pos_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]price_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]cost_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]loc_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]alt_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]dsd_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_txt_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_nut_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_cpt_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_cct_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_csl_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]scl_ctx_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]itz_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]itd_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]bmp_chg=0);
@wizRpl(Host_office.ini[DEPLOPY_CHG]clt_itm_chg=0);
