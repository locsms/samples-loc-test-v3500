...
@wizRpl(Host_office.ini[OBJ_RSP]APPLYSAMEOWNER=1);
@wizRpl(Host_office.ini[POS_RSP]APPLYSAMEOWNER=1);
@wizRpl(Host_office.ini[PRICE_RSP]APPLYSAMEOWNER=1);
@wizRpl(Host_office.ini[COST_RSP]APPLYSAMEOWNER=1);


/* NOT SUPPORT INSTORE BATCH CREATION */
@wizRpl(Host_Store.ini[FINSTORE_BAT]CREATEINSTORE=0);
