...
/* TAKE OWNERSHIP OF ANY CHANGE */

@wizRpl(Host_Store.ini[OBJ_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[POS_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[PRICE_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[COST_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[LOC_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[ALT_CHG]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[KIT_CHG]TAKEOWNERSHIP=1);

@wizRpl(Host_Store.ini[FOBJ_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FPOS_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FPRICE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FCOST_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FSPRICE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FTPRICE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FINSTORE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FREDEEM_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FGPRICE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[ALLOW_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[REBATE_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FDISC_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FCSTBRK_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FBBACK_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FGCOST_BAT]TAKEOWNERSHIP=1);
@wizRpl(Host_Store.ini[FECL_BAT]TAKEOWNERSHIP=1);
