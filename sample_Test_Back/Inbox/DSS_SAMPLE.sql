...
(30,Portal,sample_Test_Back,ROOT,INSTALL.sql,2019040 03:52:56,@DJSF @FMT(T6F,@NOW),08BB7C9C),
(30,Portal,sample_Test_Back,OFFICE,Samples.ini,2021290 20:40:16,@DJSF @FMT(T6F,@NOW),52624996),
